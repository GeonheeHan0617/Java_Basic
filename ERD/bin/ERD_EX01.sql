...
DROP TRIGGER TRI_lec_order_mem_num;
...
DROP SEQUENCE SEQ_lec_order_mem_num;
...
CREATE SEQUENCE SEQ_lec_order_mem_num INCREMENT BY 1 START WITH 1;
...
CREATE OR REPLACE TRIGGER TRI_lec_order_mem_num BEFORE INSERT ON lec_order
FOR EACH ROW
BEGIN
	SELECT SEQ_lec_order_mem_num.nextval
	INTO :new.mem_num
	FROM dual;
END;
